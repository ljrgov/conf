//作者: https://ghfast.top/https://raw.githubusercontent.com/xream/scripts/main/surge/modules/sub-store-scripts/sing-box/template.js

// 直接复制填入到链接: https://ghfast.top/raw.githubusercontent.com/ljrgov/conf/refs/heads/main/singbox/singbox.js#type=组合订阅&name=sublink&outbound=🕳ℹ️Proxy🕳ℹ️🎮 游戏🏷ℹ️^(?=.*(^.*🇯🇵.*$|^.*🇨🇳.*$))(?!(?:.*Premium|.*dj|.*lg)).*$🕳ℹ️🇭🇰 香港节点🏷ℹ️^(?=.*(?:🇭🇰))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇨🇳 台湾节点🏷ℹ️^(?=.*(?:🇨🇳|🇹🇼))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇯🇵 日本节点🏷ℹ️^(?=.*(?:🇯🇵))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇺🇸 美国节点🏷ℹ️^(?=.*(?:🇺🇸))(?!(?:.*Premium|.*游戏|.*lg|.*dj)).*$🕳ℹ️🇸🇬 新加坡节点🏷ℹ️^(?=.*(?:🇸🇬))(?!(?:.*Australia|.*游戏|.*dj|.*lg)).*$

// 或者作为本地时添加参数如下:
// type  组合订阅
// name  组合订阅名称
// outbound  🕳ℹ️Proxy🕳ℹ️🎮 游戏🏷ℹ️^(?=.*(^.*🇯🇵.*$|^.*🇨🇳.*$))(?!(?:.*Premium|.*dj|.*lg)).*$🕳ℹ️🇭🇰 香港节点🏷ℹ️^(?=.*(?:🇭🇰))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇨🇳 台湾节点🏷ℹ️^(?=.*(?:🇨🇳|🇹🇼))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇯🇵 日本节点🏷ℹ️^(?=.*(?:🇯🇵))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇺🇸 美国节点🏷ℹ️^(?=.*(?:🇺🇸))(?!(?:.*Premium|.*游戏|.*lg|.*dj)).*$🕳ℹ️🇸🇬 新加坡节点🏷ℹ️^(?=.*(?:🇸🇬))(?!(?:.*Australia|.*游戏|.*dj|.*lg)).*$
