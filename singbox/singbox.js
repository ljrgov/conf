...
//🕳ℹ️Proxy🕳ℹ️🎮 游戏🏷ℹ️^(?=.*(^.*🇯🇵.*$|^.*🇨🇳.*$))(?!(?:.*Premium|.*dj|.*lg)).*$🕳ℹ️🇭🇰 香港节点🏷ℹ️^(?=.*(?:🇭🇰))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇨🇳 台湾节点🏷ℹ️^(?=.*(?:🇨🇳|🇹🇼))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇯🇵 日本节点🏷ℹ️^(?=.*(?:🇯🇵))(?!(?:.*Premium|.*游戏|.*dj|.*lg)).*$🕳ℹ️🇺🇸 美国节点🏷ℹ️^(?=.*(?:🇺🇸))(?!(?:.*Premium|.*游戏|.*lg|.*dj)).*$🕳ℹ️🇸🇬 新加坡节点🏷ℹ️^(?=.*(?:🇸🇬))(?!(?:.*Australia|.*游戏|.*dj|.*lg)).*$
