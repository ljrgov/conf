// https://raw.githubusercontent.com/ljrgov/conf/refs/heads/main/singbox/singbox_substore.js#type=组合订阅&name=sublink&outbound=🕳ℹ️Proxy🏷ℹ️?!.*((?i)🇭🇰|🇨🇳|🇺🇸|🇯🇵|🇸🇬)).*$🕳ℹ️香港|香港(自动)🏷ℹ️港|hk|hongkong|kong kong|🇭🇰🕳ℹ️台湾|台湾(自动)🏷ℹ️台|tw|taiwan|🇹🇼|🇨🇳🕳ℹ️日本|日本(自动)🏷ℹ️日本|jp|japan|🇯🇵🕳ℹ️新加坡|新加坡(自动)🏷ℹ️^(?!.*(?:us)).*(新|sg|singapore|🇸🇬)🕳ℹ️美国|美国(自动)🏷ℹ️美|us|unitedstates|united states|🇺🇸🕳ℹ️日本游戏🏷ℹ️^(?=.*((?i)(\b(游戏|game|Game)\b)))(?!.*((?i)节点|备用|naixi|🇭🇰)).*$🕳ℹ️香港游戏🏷ℹ️^(?=.*((?i)(\b(游戏|game|Game)\b)))(?!.*((?i)节点|备用|naixi|🇯🇵)).*$
...
// 例如：#type=组合订阅&name=sublink&outbound=🕳ℹ️Proxy🏷ℹ️?!.*((?i)🇭🇰|🇨🇳|🇺🇸|🇯🇵|🇸🇬)).*$🕳ℹ️香港|香港(自动)🏷ℹ️港|hk|hongkong|kong kong|🇭🇰🕳ℹ️台湾|台湾(自动)🏷ℹ️台|tw|taiwan|🇹🇼|🇨🇳🕳ℹ️日本|日本(自动)🏷ℹ️日本|jp|japan|🇯🇵🕳ℹ️新加坡|新加坡(自动)🏷ℹ️^(?!.*(?:us)).*(新|sg|singapore|🇸🇬)🕳ℹ️美国|美国(自动)🏷ℹ️美|us|unitedstates|united states|🇺🇸🕳ℹ️日本游戏🏷ℹ️^(?=.*((?i)(\b(游戏|game|Game)\b)))(?!.*((?i)节点|备用|naixi|🇭🇰)).*$🕳ℹ️香港游戏🏷ℹ️^(?=.*((?i)(\b(游戏|game|Game)\b)))(?!.*((?i)节点|备用|naixi|🇯🇵)).*$
